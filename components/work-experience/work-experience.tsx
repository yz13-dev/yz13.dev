...
export function ExperiencePositionItem({
  ...
  return (
    <Collapsible defaultOpen={position.isExpanded} disabled={!position.description} render={<div className="relative last:before:absolute last:before:h-full last:before:w-4 last:before:bg-background" />}><CollapsibleTrigger
                className={cn(
