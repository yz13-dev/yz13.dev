...
export default function Component() {
  ...
  return (
    ...
    >
      <div className="rounded-xl bg-background border-x relative overflow-clip border-t drop-shadow-2xl h-full aspect-1200/628 group-hover:scale-105 transition-transform">
        <Image
